...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        blood.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A-", "B-", "AB", "AB+", "A+", "B+" }));
        ...
        setSize(new java.awt.Dimension(531, 543));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql="INSERT INTO STUDENT(id,stdName,stdFatherName,stdBlood,stdCity,stdPhone,class) VALUES('"+id+"','"+stdName+"','"+stdFather+"','"+stdBlood+"','"+stdCity+"','"+stdPhone+"','"+stdclass+"')";
        stmt.executeUpdate(sql);
         JOptionPane.showMessageDialog(null,"Data is successfuly inserted");
        }catch(HeadlessException | NumberFormatException | SQLException e) {
       
        JOptionPane.showMessageDialog(null,"Error::This ID is already exist !! Please try Another one");
        }
